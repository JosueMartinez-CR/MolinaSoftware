...
AS
	...
	begin tran	
		...
		delete from telefonosProveedores where idProveedor=@idProveedor and telefono = @telefono;
...
AS
	...
	begin tran	
		...
		delete from correosProveedores where idProveedor=@idProveedor and correo = @correo;
	if @@error>0
		begin
			print ('No se borró el proveedor')
			rollback transaction
